...
- [NIST AI 600-1: Generative AI Profile](https://airc.nist.gov/Docs/1) - NIST's specific guidance on managing risks from generative and foundation models, including agentic systems. Maps to the AI RMF.
...
- [Canada Artificial Intelligence and Data Act (AIDA)](https://ised-isde.canada.ca/site/innovation-better-canada/en/artificial-intelligence-and-data-act) - Canada's proposed AI regulation, part of Bill C-27. Shapes how Canadian deployments will need to be governed.
...
- [IEEE P2089](https://standards.ieee.org/ieee/P2089/7947/) - Standard for age-appropriate digital services. Relevant to AI systems that interact with or make decisions about minors.
...
- [Sleeper Agents (Hubinger et al., 2024)](https://arxiv.org/abs/2401.05566) - On models that behave differently in training versus deployment. Directly relevant to deployment-time audit requirements.
...
- [Model Cards for Model Reporting (Mitchell et al., 2019)](https://arxiv.org/abs/1810.03993) - Established the model card format. Now a de facto standard for responsible AI disclosure and referenced in several national AI governance frameworks.
...
- [Garak](https://github.com/leondz/garak) - LLM vulnerability scanner. Tests for prompt injection, data leakage, hallucination, and other failure modes.
...
- [LlamaGuard](https://github.com/meta-llama/PurpleLlama/tree/main/Llama-Guard) - Meta's open-source content-safety classification model. Designed to be used as an input-output safeguard in production LLM systems.
...
- [agentgateway](https://agentgateway.dev/) - Linux Foundation open-source proxy for MCP tool calls and agent-to-agent traffic. Includes a CEL policy engine, RBAC, and OTel emission. The governance control point for agentic tool use.
...
- [AI Fairness 360 (AIF360)](https://aif360.res.ibm.com/) - IBM Research's open-source library covering bias detection and mitigation from pre-processing through to post-processing.
...
- [NYC Local Law 144 (Automated Employment Decision Tools)](https://www.nyc.gov/site/dca/about/automated-employment-decisions-tool.page) - The first US law to mandate bias audits for AI in hiring. Sets a practical floor for what a bias audit must demonstrate.
...
- [AI Governance Weekly](https://aigovernanceweekly.com/) - Focused specifically on AI governance developments, policy updates, and enforcement actions across jurisdictions.
